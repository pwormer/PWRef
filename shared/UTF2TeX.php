<?php
        function UTF2TeX($code) {
       /*
        *   The most common UTF-8 characters that appear in western names
        ...
        */
            $UTFchars = array (           //code point UTF8        character name
                ...
                '/Å/' => '\r{A}',         // U+00C5 c3 85 Latin capital letter A with ring above
                '/Æ/' => '{\AE}',         // U+00C6 c3 86 Latin capital letter AE
                '/Č/' => '\v{C}',         // U+010C c4 8c Latin capital letter C with caron
                '/Ç/' => '\c{C}',         // U+00C7 c3 87 Latin capital letter C with cedilla
                ...
                '/Ř/' => '\v{R}',         // U+0158 c5 98 Latin capital letter R with caron
                '/Š/' => '\v{S}',         // U+0160 c5 a0 Latin capital letter S with caron
                '/Ý/' => "\'{Y}",         // U+00DD c3 9d Latin capital letter Y with acute
                '/Ỳ/' => '\`{Y}',        // U+1EF2 e1 bb b2 Latin capital letter Y with grave
                '/Ž/' => '\v{Z}',         // U+017D c5 bd Latin capital letter Z with caron
                ...
                '/å/' => '\r{a}',         // U+00E5 c3 a5 Latin small letter a with ring above
                '/æ/' => '{\ae}',         // U+00E6 c3 a6 Latin small letter ae
                '/č/' => '\v{c}',         // U+010D c4 87 Latin small letter c with caron
                '/ć/' => "\'{c}",         // U+0107 c4 8d Latin small letter c with acute
                '/ç/' => '\c{c}',         // U+00E7 c3 a7 Latin small letter c with cedilla
                ...
                '/ř/' => '\v{r}',         // U+0159 c5 99 Latin small letter r with caron
                '/š/' => '\v{s}',         // U+0161 c5 a1 latin small letter s with caron
                ...
                '/ž/' => '\v{z}',         // U+017E c5 be Latin small letter z with caron
